#!/bin/sh
# Install the parcel command on Linux or macOS from a GitHub release:
#
#   curl -LsSf https://github.com/griot-cloud/parcel/releases/latest/download/install.sh | sh
#
# PARCEL_VERSION=0.1.0 picks a release (default: the latest), and PARCEL_INSTALL_DIR picks
...
bin="parcel"
version="${PARCEL_VERSION:-latest}"
dir="${PARCEL_INSTALL_DIR:-$HOME/.local/bin}"
